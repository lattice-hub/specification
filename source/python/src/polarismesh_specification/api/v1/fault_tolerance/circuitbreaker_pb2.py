...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'\n8io.pole.specification.api.v1.fault.toleranceB\023CircuitBreakerProtoZEgithub.com/pole-io/specification/source/go/api/v1/fault_tolerance'
