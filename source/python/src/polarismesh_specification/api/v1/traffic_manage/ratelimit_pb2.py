...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'\n7io.pole.specification.api.v1.traffic.manageB\016RateLimitProtoZDgithub.com/pole-io/specification/source/go/api/v1/traffic_manage'
