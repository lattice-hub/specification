...
type DiscoverFilter struct {
	...
	// pole.io 自定义信息
	Caller *Caller `protobuf:"bytes,100,opt,name=caller,proto3" json:"caller,omitempty"`
}
...
func (x *DiscoverFilter) GetCaller() *Caller {
	if x != nil {
		return x.Caller
	}
	return nil
...
var file_request_proto_rawDesc = []byte{
	...
	0x65, 0x6c, 0x52, 0x06, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x22, 0x66, 0x0a, 0x0e, 0x44, 0x69,
	...
	0x65, 0x61, 0x6c, 0x74, 0x68, 0x79, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x12, 0x22,
	...
	0x65, 0x72, 0x22, 0xcd, 0x03, 0x0a, 0x0f, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x52,
	...
	0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x22, 0xa3, 0x02, 0x0a, 0x13, 0x44, 0x69, 0x73, 0x63, 0x6f,
	...
	0x22, 0x04, 0x08, 0x07, 0x10, 0x0b, 0x22, 0x04, 0x08, 0x0e, 0x10, 0x63, 0x4a, 0x04, 0x08, 0x03,
	0x10, 0x05, 0x42, 0x89, 0x01, 0x0a, 0x37, 0x63, 0x6f, 0x6d, 0x2e, 0x74, 0x65, 0x6e, 0x63, 0x65,
	...
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x5a, 0x40, 0x67, 0x69,
...
var file_request_proto_goTypes = []interface{}{
	...
	(*Caller)(nil),                           // 1: v1.Caller
	(*DiscoverFilter)(nil),                   // 2: v1.DiscoverFilter
	(*DiscoverRequest)(nil),                  // 3: v1.DiscoverRequest
	(*model.ClientLabel)(nil),                // 4: v1.ClientLabel
	(*Service)(nil),                          // 5: v1.Service
}
var file_request_proto_depIdxs = []int32{
	4, // 0: v1.Caller.labels:type_name -> v1.ClientLabel
	1, // 1: v1.DiscoverFilter.caller:type_name -> v1.Caller
	0, // 2: v1.DiscoverRequest.type:type_name -> v1.DiscoverRequest.DiscoverRequestType
	5, // 3: v1.DiscoverRequest.service:type_name -> v1.Service
	2, // 4: v1.DiscoverRequest.Filter:type_name -> v1.DiscoverFilter
