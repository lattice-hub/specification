...
var file_grpc_config_api_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x92,
	0x03, 0x0a, 0x11, 0x50, 0x6f, 0x6c, 0x61, 0x72, 0x69, 0x73, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	...
	,
	...
	0x67, 0x65, 0x42, 0x18, 0x50, 0x6f, 0x6c, 0x61, 0x72, 0x69, 0x73, 0x43, 0x6f, 0x6e, 0x66, 0x69,
	0x67, 0x47, 0x52, 0x50, 0x43, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x5a, 0x3f, 0x67, 0x69,
...
var file_grpc_config_api_proto_goTypes = []interface{}{
	...
	(*ConfigFilePublishInfo)(nil),  // 2: v1.ConfigFilePublishInfo
	(*ConfigFileGroupRequest)(nil), // 3: v1.ConfigFileGroupRequest
	(*ConfigDiscoverRequest)(nil),  // 4: v1.ConfigDiscoverRequest
	(*model.Response)(nil),         // 5: v1.Response
...
var file_grpc_config_api_proto_depIdxs = []int32{
	...
	2, // 3: v1.PolarisConfigGRPC.UpsertAndPublishConfigFile:input_type -> v1.ConfigFilePublishInfo
	3, // 4: v1.PolarisConfigGRPC.GetConfigFileMetadataList:input_type -> v1.ConfigFileGroupRequest
	4, // 5: v1.PolarisConfigGRPC.Discover:input_type -> v1.ConfigDiscoverRequest
	5, // 6: v1.PolarisConfigGRPC.CreateConfigFile:output_type -> v1.Response
	5, // 7: v1.PolarisConfigGRPC.UpdateConfigFile:output_type -> v1.Response
	5, // 8: v1.PolarisConfigGRPC.PublishConfigFile:output_type -> v1.Response
	5, // 9: v1.PolarisConfigGRPC.UpsertAndPublishConfigFile:output_type -> v1.Response
	5, // 10: v1.PolarisConfigGRPC.GetConfigFileMetadataList:output_type -> v1.Response
	6, // 11: v1.PolarisConfigGRPC.Discover:output_type -> v1.ConfigDiscoverResponse
...
type PolarisConfigGRPCClient interface {
	...
	// 创建/更新并发布配置
	UpsertAndPublishConfigFile(ctx context.Context, in *ConfigFilePublishInfo, opts ...grpc.CallOption) (*model.Response, error)
	// 拉取指定配置分组下的配置文件列表
	GetConfigFileMetadataList(ctx context.Context, in *ConfigFileGroupRequest, opts ...grpc.CallOption) (*model.Response, error)
	// 统一发现接口
...
func (c *polarisConfigGRPCClient) UpsertAndPublishConfigFile(ctx context.Context, in *ConfigFilePublishInfo, opts ...grpc.CallOption) (*model.Response, error) {
	out := new(model.Response)
...
func (c *polarisConfigGRPCClient) GetConfigFileMetadataList(ctx context.Context, in *ConfigFileGroupRequest, opts ...grpc.CallOption) (*model.Response, error) {
	out := new(model.Response)
...
type PolarisConfigGRPCServer interface {
	...
	// 创建/更新并发布配置
	UpsertAndPublishConfigFile(context.Context, *ConfigFilePublishInfo) (*model.Response, error)
	// 拉取指定配置分组下的配置文件列表
	GetConfigFileMetadataList(context.Context, *ConfigFileGroupRequest) (*model.Response, error)
	// 统一发现接口
...
func (*UnimplementedPolarisConfigGRPCServer) UpsertAndPublishConfigFile(context.Context, *ConfigFilePublishInfo) (*model.Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpsertAndPublishConfigFile not implemented")
}
func (*UnimplementedPolarisConfigGRPCServer) GetConfigFileMetadataList(context.Context, *ConfigFileGroupRequest) (*model.Response, error) {
